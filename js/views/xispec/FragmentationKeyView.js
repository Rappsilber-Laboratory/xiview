...
export const FragmentationKeyView = Backbone.View.extend({
    ...
    updateColors: function () {
        ...
        //         if (lines[l].bText) lines[l].bText.style("fill", this.backbone-models.p1color);
        //         if (lines[l].yText) lines[l].yText.style("fill", this.backbone-models.p1color);
        // 	}
        // 	else if (lines[l].peptideId == 1){
        //         if (lines[l].bText) lines[l].bText.style("fill", this.backbone-models.p2color);
        //         if (lines[l].yText) lines[l].yText.style("fill", this.backbone-models.p2color);
        // 	}
        // }
        // this.colorLetters("all");
        this.render();
    ...
    //             this.fraglines[i].bHighlight.attr("stroke", this.backbone-models.get('highlightColor'));
    //         if (this.fraglines[i].yHighlight !== undefined)
    //             this.fraglines[i].yHighlight.attr("stroke", this.backbone-models.get('highlightColor'));
    //     }
    //
    // },
    ...
    //     if (_.intersection(this.backbone-models.sticky, this.fraglines[f].fragments).length == 0) {
