 ...
 * Handles user interactions, backbone-models updates, and coordinates with the Graph component.
 *
 * @class SpectrumView
...
export const SpectrumView = Backbone.View.extend({
    ...
    initialize: function (viewOptions) {
        ...
        //this.listenTo(this.backbone-models, 'destroy', this.remove);
    },

    /**
     * Renders the spectrum view.
     * Clears the current graph and redraws with current backbone-models data.
     *
     * @method render
    ...
    /**
     * Updates the displayed m/z range when the backbone-models's mzRange changes.
     *
    ...
    /**
     * Shows or hides lossy fragment labels based on backbone-models setting.
     *
     * @method showLossy
     */
    showLossy: function () {
    ...
    /**
     * Toggles zoom locking on/off based on backbone-models setting.
     *
    ...
    /**
     * Updates which peaks are highlighted based on the backbone-models's highlight state.
     *
