...
/**
 * Backbone backbone-models for storing and managing annotated mass spectrum data.
...
export const AnnotatedSpectrumModel = Backbone.Model.extend({
    ...
    /**
     * Default backbone-models attributes and visualization settings.
     *
    ...
    /**
     * Clears all spectrum data and resets the backbone-models to empty state.
     *
     * @method clear
     */
    clear: function () {
    ...
    changeLinkPos: function (newLinkSites) {
        ...
        // make sure this backbone-models is in the activated SpectrumWrapper
