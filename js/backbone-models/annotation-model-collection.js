/**
 * @fileoverview Annotation type backbone-models and collection for managing protein sequence annotations.
...
/**
 * Annotation type backbone-models representing a category/type pair for protein annotations.
...
export class AnnotationTypeCollection extends Backbone.Collection {
     ...
     * @param {Array} models - Initial clms-backbone-models (unused)
    ...
    /**
     * Generates unique backbone-models ID from category and type attributes.
     * Prevents duplicate IDs when adding clms-backbone-models to collection.
     ...
     * Caches result in annotation type backbone-models. Returns gray if annotation type not found.
