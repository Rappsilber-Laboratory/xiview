/**
 * @fileoverview Protein-specific color backbone-models classes.
...
/**
 * Default protein color backbone-models - assigns single color to all proteins.
 * Simple ordinal color backbone-models with one category ("Protein") and one color.
...
export class DefaultProteinColourModel extends ColourModel {
    /**
     * Initializes the default protein color backbone-models.
...
/**
 * Manual protein color backbone-models - allows per-protein color assignment.
...
export class ManualColourModel extends ColourModel {
    ...
    /**
     * Initializes the manual color backbone-models with empty assignment map.
     * @returns {undefined}
     */
    initialize() {
