/**
 * @fileoverview Crosslink-specific color backbone-models classes for xiVIEW.
...
/**
 * Default crosslink color backbone-models - colors by link type (self/homomultimeric/heteromeric).
...
/**
 * Group-based color backbone-models - colors crosslinks by search group.
...
export class GroupColourModel extends ColourModel {
    ...
    /**
     * Initializes group-based color backbone-models by analyzing search-to-group mappings.
...
/**
 * Distance-based threshold color backbone-models - colors crosslinks by Ca-Ca distance.
...
/**
 * Protein-pair-based color backbone-models - colors crosslinks by protein pair involved.
...
export class InterProteinColourModel extends ColourModel {
    ...
    /**
     * Initializes protein-pair color backbone-models by creating ordinal scale.
...
/**
 * Score-based threshold color backbone-models - colors crosslinks by highest match score.
