...
CLMSUI.BackboneModelTypes.ColorModel = Backbone.Model.extend({
    ...
    getDomainIndex: function (obj) {    // obj is generally a crosslink, but is non-specific at this point
        ...
        // const returnVal = typeof (val) === "undefined" ? (this.get("type") !== "categorical" ? d3.bisect(dom, val) : dom.indexOf(val)) : undefined;
        const returnVal = typeof (val) === "undefined" ? (this.get("type") !== "categorical" ? d3.bisect(dom, val) : dom.indexOf(val)) : undefined;
        // const returnVal = typeof (val) === "undefined" ? dom.indexOf(val) : undefined;
